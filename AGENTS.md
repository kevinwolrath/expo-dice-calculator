...
This is an **Android / iOS Expo app**. It is not a web product.

Expo Web may be used for quick UI checks in a browser. Do not treat web as a shipping target:

- Implement and verify features on mobile first.
