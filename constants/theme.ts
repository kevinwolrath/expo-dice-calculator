...
export const Layout = {
  ...
  cardGap: 16,
  cardPadding: 16,
  /** Tighter than list cards. Single-value fields should not sit in a tall empty panel. */
  fieldGap: 8,
  fieldPadding: 10,
  cardRadius: 16,
  panelBorderWidth: 1,
  ...
  labelGap: 4,
  controlHeight: 44,
  /** Compact width for a small numeric value such as a colour count. */
  numericFieldWidth: 112,
  buttonHeight: 56,
  notesHeight: 100,
  listGutter: 16,
  headerSpacer: 96,
